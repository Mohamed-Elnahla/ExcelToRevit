...
internal class ColumnsFamilies : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        try
        {
            ...
            //Family Path
            FileName = "C:/Program Files/Elnahla Revit Plugin/Families/Conc.Columns.rfa";

            using (var trans = new Transaction(doc, "Import Columns Family"))
            {
                trans.Start();
            ...
            using (var ExcelPack = new ExcelPackage(new FileInfo(Excelfile)))
            {
                ...
                using (var newFamilyTypeTransaction = new Transaction(familyDoc, "Add Type to Family"))
                {
                    ...
                    TaskDialog.Show("Revit", "New Columns Types Created Successfully");
                }
            }
