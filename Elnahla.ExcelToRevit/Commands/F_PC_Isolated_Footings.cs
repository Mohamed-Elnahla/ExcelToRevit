...
internal class F_PC_Isolated_Footings : IExternalCommand
{
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        try
        {
            ...
            //Family Path
            FileName = "C:/Program Files/Elnahla Revit Plugin/Families/PC-Iso_Footing.rfa";

            using (var trans = new Transaction(doc, "Import PC Footings Family"))
            {
                trans.Start();
            ...
            using (var ExcelPack = new ExcelPackage(new FileInfo(Excelfile)))
            {
                ...
                using (var newFamilyTypeTransaction = new Transaction(familyDoc, "Add Type to Family"))
                {
                    ...
                    TaskDialog.Show("Revit", "New PC Footings Types Created Successfully");
                }
            }
